...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/mksingh/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/mksingh/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/mksingh/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/mksingh/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/mksingh/Projects/foobar/lib/utils")
})
