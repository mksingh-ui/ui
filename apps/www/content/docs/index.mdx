...
You can use any framework that supports React. [Next.js](https://ui.mksingh.in/docs/installation/next), [Astro](https://ui.mksingh.in/docs/installation/astro), [Remix](https://ui.mksingh.in/docs/installation/remix), [Gatsby](https://ui.mksingh.in/docs/installation/gatsby) etc.
